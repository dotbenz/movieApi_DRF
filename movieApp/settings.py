...
SECRET_KEY = 'django-insecure-y48git+z2b1!(26#k1qpt8@1!9x38lajbkz!&1+v*2dyiho+2d'
...
INTERNAL_IPS = [
    # ...
    '127.0.0.1',
    # Add your local IP address(es) here
]
...
#         'LOCATION': 'redis://127.0.0.1:6379/',  # Use your Redis server's address
#         'OPTIONS': {
